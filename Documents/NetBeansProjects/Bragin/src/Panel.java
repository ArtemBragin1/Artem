...
public class Panel extends javax.swing.JFrame {
    ...
    public void asd() {
        ...
        jLabel21.setText(jLabel21.getText() + maxElements[col] + ", ");//добавляем в лист максимальные числа из каждого столбца
    ...
    public void table1() {
        ...
        int[][] firstdoublemassiv = new int[row][col];//создаем двумерный массив
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Зашифровать введенную с клавиатуры строку, поменяв местами первый символ с третьим, второй с четвертым. Провести дешифровку.");
        ...
        jLabel23.setText("Создать функцию пользователя, определяющую наибольшую цифру введенного натурального числа.");
        ...
        jLabel22.setText("Отлиники в 301");
    ...
    public class Schule {
        ...
        public Schule(String familiya, String imya, String otchestvo, String group, int ocenka) {
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        String[] group = {"301", "302", "301", "302", "301", "302"};
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (group[i].equals("301") && ocenka[i] >= 4) {
                list3.addElement(human.getImya() + " " + human.getFamiliya() + " " + human.getOtchestvo() + "Группа: "
                        + human.getGroup() + " " + "Оценка:" + human.getOcenka());
            }
        }
